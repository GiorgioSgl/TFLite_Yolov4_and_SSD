...
This is a resume of the results, seems YOLO lost a lot causeof the conversione to the FLite framework. The frame per second are calcualted on a raspeberry pi4.

I also add in the normal detection of the video for SSD video a calculation of the FPS.

## Guide from[TFLite in raspberry repository](https://github.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/blob/master/Raspberry_Pi_Guide.md)
...
<p align="center">
  <img src="https://raw.githubusercontent.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/master/doc/camera_enabled.png">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/master/doc/tflite1_folder.png">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/EdjeElectronics/TensorFlow-Lite-Object-Detection-on-Android-and-Raspberry-Pi/master/doc/BSR_directory1.png">
</p>
...
##### Run the TensorFlow Lite YOLO model

For detecting video. You will go in output the FPS per each frame
```
python3 TFLite_detection_video_YOLO.py --modeldir=Sample_TFLite_model_yolo
```
For detecting Image
```
python3 TFLite_detection_image_YOLO.py --modeldir=Sample_TFLite_model_yolo
```
